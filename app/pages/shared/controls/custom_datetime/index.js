...
var _DateTimePickerJs = require("react-bootstrap-datetimepicker/lib/DateTimePicker.js");

var _DateTimePickerJs2 = _interopRequireDefault(_DateTimePickerJs);

var _ConstantsJs = require("react-bootstrap-datetimepicker/lib/Constants.js");
...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.onChange = function (event) {
      ...
      if(value.includes(":")&&value.length==5){
        ...
        value=strNew[0]+":"+strNew[1];
      }
      if(value.includes("pm")&&value.length==7){        
        value = value.substr(0,5);
        value = value + " " + "pm";
      }else if(value.includes("am")&&value.length==7){
        value = value.substr(0,5);
        value = value + " " + "am";
      }
  ...
  _createClass(DateTimeField, [{
    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement(
            "span",
            { className: "input-group-addon", onBlur: this.onBlur,  onClick: !this.props.disabled?this.onClick:null, ref: "dtpbutton" },
    ...
    key: "propTypes",
    value: {
      dateTime: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number,_react.PropTypes.object]),

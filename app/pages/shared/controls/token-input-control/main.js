...
module.exports = React.createClass({
  ...
  handleRemoveLast: function handleRemoveLast() {
    this.props.onRemove(this.props.selected ? this.props.selected[this.props.selected.length - 1] : {});
  },
  render: function render() {
    ...
    return ul({ className: classes, onClick: this.handleClick }, tokens, li({
      className: 'inline-flex', style: { width: "250px" }, ref: 'combo-li'
    }, Combobox({
      id: this.props.id,
